...
LinkCollector = do_import("collector", "LinkCollector")
SearchScope = do_import("models.search_scope", "SearchScope")
TargetPython = do_import("models.target_python", "TargetPython")
