...
def test_command_line_pipfile_read(pip_conf, runner):
    ...
    assert out.stderr == dedent(expected_output), "{} != {}".format(out.stderr, dedent(expected_output))
...
def test_command_line_pipfile_dev(pip_conf, runner):
    ...
    assert out.stderr == expected_output, "{} != {}".format(out.stderr, expected_output)

    out = runner.invoke(cli, ["--no-emit-find-links", "--pipfile-dev"], catch_exceptions=False)
